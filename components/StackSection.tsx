  ...
  return (
    <section id="stack" className="container py-14 sm:py-16">
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="group relative rounded-3xl transition-transform duration-300 hover:scale-[1.02]">
          <div
            className="rounded-3xl border bg-card/90 p-6 md:p-7 shadow-sm"
            style={{
          ...
          >
            ...
            <svg className="pointer-events-none absolute bottom-2 right-2 h-16 w-40 opacity-70" viewBox="0 0 160 64" fill="none">
              <path className="chart-path" d="M0 56 C 20 40, 40 44, 60 28 S 100 20, 120 36 S 140 44, 160 24" stroke="url(#grad)" strokeWidth="3" />
              <defs>
        ...
        <div className="group relative rounded-3xl transition-transform duration-300 hover:scale-[1.02]">
          ...
          >
            ...
            <p className="mt-2 text-xs text-white/70">Командные методологии и планирование</p>
            <div className="mt-3 flex flex-wrap gap-2">
              <span className="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-white/80">Scrum</span>
              <span className="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-white/80">Agile</span>
            </div>
          </div>
          <span
            aria-hidden
